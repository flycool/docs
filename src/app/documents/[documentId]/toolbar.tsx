...
const FontFamilyButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="h-7 w-[120px] shrink-0 flex items-center justify-between 
        rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
        >
...
export default function Toolbar() {
  ...
  return (
    <div
      className="
        bg-[#f1f4f9] px-2.5 py-0.5 rounded-[24px] min-h-[40xpx] flex items-center gap-x-0.5 overflow-x-auto 
        "
    >
      {sections[0].map((item) => (
